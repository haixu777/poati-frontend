  ...
  data () {
    return {
      contestList: {
        ...
        year_2017: [
          { logo: '', path: '/2017/gjccq', title: '关键词抽取', introdution: '给定一组新闻文档，从每一篇文档中抽取出与该文档主题最相关的一些词或者短语。', time: '2017/09/01 - 2017/10/30', location: '北京益园', status: 0 },
          { logo: '', path: '/2017/wbfl', title: '文本分类', introdution: '给定一组未经分词的文本文档，对每一篇文档指定唯一类别。按文本类型分为两个子任务：新闻报道分类和短文本分类。', time: '2017/09/01 - 2017/10/30', location: '北京益园2017', status: 0 },
          { logo: '', path: '/2017/sjybfx', title: '事件样本发现', introdution: '本任务的目标是从给定语料中查找与指定事件对应的新闻语料。', time: '2017/09/01 - 2017/10/30', location: '北京益园', status: 0 },
          { logo: '', path: '/2017/sjgjyssb', title: '事件关键元素识别', introdution: '本任务的目标是从给定语料中抽取出描述指定事件的关键元素。', time: '2017/09/01 - 2017/10/30', location: '北京益园', status: 0 },
          // { logo: '', path: '/2017/sjgxcq', title: '事件关系抽取', introdution: '从新闻文档中提取相应新闻事件的相关参数。本任务提供每一篇新闻文档对应的新闻事件及关 键元素集合，需要识别出事件的类别，以及该事件类别下每一个参数对应的基本实体。', time: '2017/09/01 - 2017/10/30', location: '北京益园', status: 0 },
          { logo: '', path: '/2017/sjgxyc', title: '社交关系预测', introdution: '本任务的目标是根据社交网络用户的基本信息、发布消息内容、回复消息内容、关注主题、用户间的社交关系（包括回帖、点赞、评论等），预测用户之间可能建立的关注关系。', time: '2017/09/01 - 2017/10/30', location: '北京益园', status: 0 },
          { logo: '', path: '/2017/yhhx', title: '用户画像', introdution: '给定一批社交网络用户数据，包括用户个人信息、用户行为信息、用户社交网络文本以及用户粉丝列表等，预测社交网络用户的四类属性标签。', time: '2017/09/01 - 2017/10/30', location: '北京益园', status: 0 }
        ]
      },
