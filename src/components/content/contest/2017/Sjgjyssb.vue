  ...
  <div class="container contest_details_container">
    ...
    <div class="container_right">
      <div class="introdution" v-show="activeName=='比赛介绍'">
        <p>给定新闻事件样本，抽取其中的基本实体，包括时间、地点、参与人物和参与组织。</p>
        <ol>
          <li>输入：不同专题下的新闻样本</li>
          <li>输出：每个样本中对应的基本实体</li>
        </ol>
        <p>如下事例:<p>
      ...
      <div class="introdution" v-show="activeName=='比赛数据'">
        ...
        <p>数据均来源于互联网，主要为新浪网站的数据以及国外网站作为补充，其中事件类型涵盖国
          ...
          txt的形式保存作为标准结果。</p>
        <h5>数据集</h5>
        <p>TEST/ELEMENTS_TEST 测试文档</p>
        <p>STANDARD/ELEMENTS_ STANDARD 标准结果文档</p>
        <h5>数据格式</h5>
        <p>数据字段</p>
      ...
      <div class="introdution" v-show="activeName=='评分标准'">
        ...
        <p>基于以上等价关系，我们定义集合与的交集为</p>
        <img :src="require('../../../../assets/contest/details/sjgjyssb5.png')"
      </div>
